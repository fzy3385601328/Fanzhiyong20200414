...
import com.example.fanzhiyong20200414.presenter.RegisterPresenter;
...
public class RegisterActivity extends BaseActivity implements IContract.IView {
            ...
            public void onClick(View v) {
                ...
                if (!TextUtils.isEmpty(phone)&&!TextUtils.isEmpty(pwd)){
                    ...
                    if (VolleyUtil.isActivice(getBaseContext())){
                        ...
                        //失败后吐司没网
                        Toast.makeText(RegisterActivity.this, "无网络状态", Toast.LENGTH_SHORT).show();
                    }
                }else {
                    Toast.makeText(RegisterActivity.this, "请输入正确的用户名或者密码", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
